...
const u32 gTrainerFrontPic_LeaderViola[] = INCBIN_U32("graphics/trainers/front_pics/leader_viola.4bpp.smol");
const u16 gTrainerPalette_LeaderViola[] = INCBIN_U16("graphics/trainers/front_pics/leader_viola.gbapal");
...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(TRAINER_PIC_DOME_ACE_TUCKER, gTrainerFrontPic_DomeAceTucker, gTrainerPalette_DomeAceTucker, -11, 6, 0x194),
    TRAINER_SPRITE(TRAINER_PIC_PALACE_MAVEN_SPENSER, gTrainerFrontPic_PalaceMavenSpenser, gTrainerPalette_PalaceMavenSpenser, -4, 6, 0x194),
    ...
    TRAINER_SPRITE(TRAINER_PIC_PIKE_QUEEN_LUCY, gTrainerFrontPic_PikeQueenLucy, gTrainerPalette_PikeQueenLucy, -4, 6, 0x194),
    TRAINER_SPRITE(TRAINER_PIC_PYRAMID_KING_BRANDON, gTrainerFrontPic_PyramidKingBrandon, gTrainerPalette_PyramidKingBrandon, -4, 6, 0x194),
    ...
    TRAINER_SPRITE(TRAINER_PIC_LEADER_VIOLA, gTrainerFrontPic_LeaderViola, gTrainerPalette_LeaderViola),
