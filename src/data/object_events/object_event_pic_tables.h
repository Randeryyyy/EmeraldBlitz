...
static const struct SpriteFrameImage sPicTable_Viola[] = {
    overworld_frame(gObjectEventPic_Viola, 2, 4, 0),
    overworld_frame(gObjectEventPic_Viola, 2, 4, 1),
    overworld_frame(gObjectEventPic_Viola, 2, 4, 2),
    overworld_frame(gObjectEventPic_Viola, 2, 4, 0),
    overworld_frame(gObjectEventPic_Viola, 2, 4, 0),
    overworld_frame(gObjectEventPic_Viola, 2, 4, 1),
    overworld_frame(gObjectEventPic_Viola, 2, 4, 1),
