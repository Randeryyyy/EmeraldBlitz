...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_ANDRES] = REMATCH(TRAINER_ANDRES_1, TRAINER_ANDRES_1, TRAINER_ANDRES_1, TRAINER_ANDRES_1, TRAINER_ANDRES_1, MAP_ROUTE105),
    ...
    [REMATCH_CRISTIN] = REMATCH(TRAINER_CRISTIN_1, TRAINER_CRISTIN_1, TRAINER_CRISTIN_1, TRAINER_CRISTIN_1, TRAINER_CRISTIN_1, MAP_ROUTE121),
    ...
    [REMATCH_KOJI] = REMATCH(TRAINER_KOJI_1, TRAINER_KOJI_1, TRAINER_KOJI_1, TRAINER_KOJI_1, TRAINER_KOJI_1, MAP_ROUTE127),
    [REMATCH_FERNANDO] = REMATCH(TRAINER_FERNANDO_1, TRAINER_FERNANDO_1, TRAINER_FERNANDO_1, TRAINER_FERNANDO_1, TRAINER_FERNANDO_1, MAP_ROUTE123),
    ...
    [REMATCH_PABLO] = REMATCH(TRAINER_PABLO_1, TRAINER_PABLO_1, TRAINER_PABLO_1, TRAINER_PABLO_1, TRAINER_PABLO_1, MAP_ROUTE126),
    ...
    [REMATCH_CORY] = REMATCH(TRAINER_CORY_1, TRAINER_CORY_1, TRAINER_CORY_1, TRAINER_CORY_1, TRAINER_CORY_1, MAP_ROUTE108),
